...
import { Card, Button, message, Row, Col, List } from "antd";
...
const PaymentResultStepMoMo = ({ transactionInfo }) => {
  ...
  }, [transactionInfo, cartItems, allProducts, orderSent, dispatch]);
  ...
  const resetCart = async () => {
    try {
      ...
      if (authToken) {
        ...
        await axios.patch("https://kiemhieptinhduyen.one/api/cartreset", null, {
          headers,
        });
