    ...
    <div style={{ padding: '20px' }}>
      ...
      {orderData && (
        <Card title={`Order Details: ${orderNumber}`} style={{ marginTop: '20px' }}>
          ...
          <p><strong>Total Bill:</strong> {new Intl.NumberFormat('en-US').format(orderData.totalBill)} VND</p>
          <p><strong>Status:</strong> {orderData.status}</p>
          <p><strong>Payment Method:</strong> {orderData.PaymentMethodChangeEvent}</p>
          ...
          {isPhoneVerified && (
            <>
              <p><strong>Receiver Name:</strong> {orderData.receiverName}</p>
